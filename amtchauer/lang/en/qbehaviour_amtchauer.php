...
/**
 * Strings for component 'qbehaviour_amtchauer', language 'en'.
 *
 * @package    qbehaviour
...
$string['pluginname'] = 'Amtchauer mode';
$string['level0']='Слабый';
$string['level1']='Средний';
$string['level2']='Хороший';
$string['level3']='Высокий';
$string['privacy:metadata'] = 'The Amtchauer mode question behaviour plugin does not store any personal data.';
