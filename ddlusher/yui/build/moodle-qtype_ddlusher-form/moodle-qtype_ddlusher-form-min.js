YUI.add("moodle-qtype_ddlusher-form", function(e, t) {
    ...
    e.extend(r, M.qtype_ddlusher.dd_base_class, {
        pendingid: "",
        fp: null,
        initializer: function() {  var nextButt = document.getElementsByName("additems");
            nextButt.item(0).setAttribute("hidden","true"); nextButt.item(1).setAttribute("hidden","true"); this.pendingid = "qtype_ddlusher-form-" + Math.random().toString(36).slice(2), M.util.js_pending(this.pendingid), this.fp = this.file_pickers(); var t = e.one(this.get("topnode"));
